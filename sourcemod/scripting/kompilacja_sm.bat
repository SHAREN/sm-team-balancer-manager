...
set compiler=D:\Programy\Source Mod\1.8.0\addons\sourcemod\scripting\spcomp.exe

if not exist "%compiler%" ( echo Kompilator %compiler% nie istnieje & goto WYJSCIE )

rem —cie¾ka do plik¢w .inc
set include=D:\Programy\Source Mod\1.8.0\addons\sourcemod\scripting\include
